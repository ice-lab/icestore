...
export function createModel<C extends Config, K = string>(config: C, namespace?: K, modelsActions?) {
  ...
  function useEffects(state: IModelState, setState: ReactSetState<IModelState>): [
    ...
    }, [effectsPayload, effectsPayloadIdentifier, setEffectsState, setState, state]);
